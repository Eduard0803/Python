...
if escolha_anexo == 1:
    numero_de_anexos = int(
        input("Digite a quantidade de anexos que quer colocar no e-mail: ")
    )
    m = 0
    while m < numero_de_anexos:
        m = m + 1
        anexo = input(
            "Digite o caminho do arquivo para anexar no e-mail: "
        )  # Pega o endereço dos arquivos de anexo
